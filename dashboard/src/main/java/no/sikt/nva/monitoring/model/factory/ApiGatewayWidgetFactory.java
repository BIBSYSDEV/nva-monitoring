...
public class ApiGatewayWidgetFactory {
  ...
  public CloudWatchWidget<MetricProperties> creatCloudWatchWidget(
      int widgetIndex, String metricName) {
  ...
  private List<Object> createMetric(String metricName, String apiId) {
    return List.of(
        AWS_API_GATEWAY, metricName, API_NAME, apiId, new MetricWidgetObject(REGION, "Sum"));
  }
