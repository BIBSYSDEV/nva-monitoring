...
public record LogQuery(
    List<String> logGroups, String filter, String fields, String stats, String sort, String limit) {
  ...
  public String constructQuery() {
    var logGroups =
        logGroups().stream().map(LogQuery::toSource).collect(Collectors.joining(DELIMITER));
