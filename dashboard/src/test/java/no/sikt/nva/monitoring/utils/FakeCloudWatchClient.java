...
public class FakeCloudWatchClient implements CloudWatchClient {
  ...
  public static final String ALARM_ARN_1 =
      "arn:aws:cloudwatch:eu-west-1:some-account:alarm:some-alarm-1";
  public static final String ALARM_ARN_2 =
      "arn:aws:cloudwatch:eu-west-1:some-account:alarm:some-alarm-2";
  public static final String ALARM_ARN_3 =
      "arn:aws:cloudwatch:eu-west-1:some-account:alarm:TargetTracking-function" + ":some-alarm-3";
  ...
  public DescribeAlarmsResponse describeAlarms() {
    return DescribeAlarmsResponse.builder()
        .metricAlarms(
            MetricAlarm.builder().alarmArn(ALARM_ARN_1).build(),
