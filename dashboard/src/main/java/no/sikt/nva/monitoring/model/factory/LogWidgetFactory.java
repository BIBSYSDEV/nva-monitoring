...
public class LogWidgetFactory {
  ...
  public static final String DEFAULT_STATS =
  ...
  public CloudWatchWidget<LogProperties> createLogWidgetForApiGatewayLogs(
      String title, String filter, int coordinateX) {
    ...
    return new CloudWatchWidget<>(
        LOG, constructLogProperties(title, query), HEIGHT, WIDTH, coordinateX, Y);
  }
  ...
  private static String constructQueryForLogGroupsWithFilter(
      List<String> logGroups, String filter) {
  ...
  private static DescribeLogGroupsRequest createListLogGroupRequestWithNamePattern(
      String nextToken) {
